...
function sumArray(testArray){ //eslint-disable-line
    const sumNumbersA = sum(testArray[0], testArray[1])[0];
    const sumNumbersB = sum(sumNumbersA, testArray[2])[0];
    console.log(sumNumbersB);
    return [
        sumNumbersB,
        testArray + ' was passed in as an array of numbers, and ' + sumNumbersB + ' is their sum.',
    ];
}
...
function multiplyArray(testArray){ //eslint-disable-line
    const productNumbersA = multiply(testArray[0], testArray[1])[0];
    const productNumbersB = multiply(productNumbersA, testArray[2])[0];
    console.log(productNumbersB);
    return [
        productNumbersB,
        'The numbers ' + testArray + ' have a product of ' + productNumbersB + '.',
    ];
